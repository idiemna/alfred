...
export default function SearchBar() {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className={`bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-4 py-2 rounded transition-all duration-200 flex items-center justify-center gap-2 w-40`}
      >
        <Image
          src="/find.png"
          alt="Buscar"
